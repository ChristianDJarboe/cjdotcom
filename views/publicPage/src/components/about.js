  ...
  render(){
    return (
     <div className="foreground">
      ...
      {/* <div className="span alignCenter" id="pp">
        ...
        <div id="aboutParagraphs">
          ...
          <div>
            <p className="c5 pad roundCorners">I’m 20 years old, born in California, raised in Washington, and now living in Texas. I’ve been working on/with computers since I was 9 when my mom gave me a broken laptop and said “if you want a computer, fix this one” and so I did. <br></br><br></br>
          ...
          <div>
            <p className="c5 pad roundCorners">Now, I have finished my classes at Austin Coding Academy. Covid slowed things down and I took a couple classes off to pursue my dreams but it finally happened. I can build a front end in react or vanilla js+jquery, a back-end in express.js, and a mysql database. I’m ready to get to work.
